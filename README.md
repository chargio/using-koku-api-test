An example of using openapi-client to generate a working API client that works, and fulfill some use cases in Python
It uses the latest version of the open api definition and uses it with code in Python to generate reports.
