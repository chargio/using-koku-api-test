...
from openapi_client.models.provider_out_all_of import ProviderOutAllOf  # noqa: E501
from openapi_client.rest import ApiException

class TestProviderOutAllOf(unittest.TestCase):
    """ProviderOutAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ProviderOutAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.provider_out_all_of.ProviderOutAllOf()  # noqa: E501
        if include_optional :
            return ProviderOutAllOf(
