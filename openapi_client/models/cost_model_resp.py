...
class CostModelResp(object):
    ...
    openapi_types = {
        ...
        'description': 'str',
        'source_type': 'str',
        'sources': 'list[CostModelRespSources]',
        'rates': 'list[Rate]'
    }
    ...
    def __init__(self, name=None, description=None, source_type=None, sources=None, rates=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def sources(self):
        """Gets the sources of this CostModelResp.  # noqa: E501


        :return: The sources of this CostModelResp.  # noqa: E501
        :rtype: list[CostModelRespSources]
        """
        return self._sources

    @sources.setter
    def sources(self, sources):
        """Sets the sources of this CostModelResp.


        :param sources: The sources of this CostModelResp.  # noqa: E501
        :type: list[CostModelRespSources]
        """
